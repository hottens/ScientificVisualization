...
class Action(enum.Enum):
    ...
    SET_ISO_CLAMP_MIN = 60
    SET_ISO_CLAMP_MAX = 61
    SET_FIELD_CLAMP_MIN = 62
    ...
    THREEDIM_TYPE_DENSITY = 77
    THREEDIM_TYPE_VELOCITY = 78
    THREEDIM_TYPE_DIVERGENCE = 79
    THREEDIM_TYPE_DIVERGENCE_FORCE = 80
    THREEDIM_TYPE_FORCES = 81
