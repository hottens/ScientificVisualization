...
VDisplaceB.grid(row=3, column =8, columnspan=7, sticky='WE', padx=5, pady=5, ipadx=5, ipady=5)
VdatatypeB.grid(row = 4, column = 8,  columnspan=7, sticky='WE', padx=5, pady=5, ipadx=5, ipady=5)
B.pack()
ColorDir.pack()
vecColDropdown.pack()
VNlevels.pack()
